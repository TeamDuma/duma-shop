  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        {discount && (
          <div className="absolute top-3 rounded bg-dumaorange px-1.5 text-xs font-semibold leading-6 text-light ltr:right-3 rtl:left-3 sm:px-2 md:top-4 md:px-2.5 ltr:md:right-4 rtl:md:left-4">
            {discount}
          </div>
        )}
      </div>
